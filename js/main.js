...
$(document).ready(function(){
	...
	//1대매뉴1-gnb_depth2_1 서브메뉴 마우스 오버액션
	$('.openAll1').mouseover(function(){

	});
	//2대매뉴1-gnb_depth2_1  서브메뉴 마우스 선택액션
	$('.openAll1').focus(function(){

	});
	//3대매뉴1-gnb_depth2_1   서브메뉴 마우스 아웃액션
	...
	//8첫번째 서브메뉴중 마지막 마지막 li태그(해외)를 벗어났을때 액션
